...
//        $allfriendsposts = [];
    ...
    public function viewpost($post_id)
    {
        ...
        $thecomments = DB::table('profileinfo')->join('comments', 'profileinfo.username', '=', 'comments.username')->where('post_id', $post_id)->orderBy('comments.created_at', 'desc')->paginate(10);
