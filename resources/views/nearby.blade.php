                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="row frend-area infinite-scroll">
                                ...
                                <br>
                                <h5><i class="fa fa-location-arrow fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Your location is NEVER shared with anyone.<br> Only a general radius is collected in order to see who is close while Protecting your Privacy.</h5>
                                <br>
