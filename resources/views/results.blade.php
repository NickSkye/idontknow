                            ...
                            <div>
                                ...
                                <div class="infinite-scroll">
                                    ...
                                    @foreach($searchedusers as $user)
                                        ...
                                        <a href="/users/{{$user->username}}" class="col-12 col-sm-4" style=" background-image: url('{{$user->profileimage}}'); padding-bottom: 31.33333333%; width: 100%; height: 100%; background-size: cover; background-repeat: no-repeat; margin: 1%;">
