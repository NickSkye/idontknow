...
$(document).ready(function(){
    ...
    function updatechat(id){
        ...
        $.ajax({
            ...
            var updated = "What You May Have Missed: <br><br> ";
           console.log(response[0][0]);

            $.each(response[0], function(k, v) {
                updated += '<div class="other-topicchat"><p><a href="/users/"' + v["username"] + ' style="font-size: 12pt;">' + v["username"] + '</a> <br> ' + v["message"] + ' </p></div>'
                    });
